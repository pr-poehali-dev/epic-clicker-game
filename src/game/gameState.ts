...
export const ASSASSIN_IMG = 'https://cdn.poehali.dev/projects/c08227df-27ea-40bf-a221-a87bc3b01e6d/files/19f61d32-2448-457c-a19b-f9f91001606b.jpg';
export const SHAMAN_IMG = 'https://cdn.poehali.dev/projects/c08227df-27ea-40bf-a221-a87bc3b01e6d/files/2406c952-0458-434c-8552-3ecde87540e6.jpg';
export const WITCH_IMG = 'https://cdn.poehali.dev/projects/c08227df-27ea-40bf-a221-a87bc3b01e6d/files/caaa2075-abde-41cc-aec4-4820eb702c2a.jpg';
export const DEATH_KNIGHT_IMG = 'https://cdn.poehali.dev/projects/c08227df-27ea-40bf-a221-a87bc3b01e6d/files/1e98b1eb-916e-4c9c-ac24-7d62d1431abd.jpg';
...
export const initialCharacters: Character[] = [
  ...
  },
  {
    ...
    dps: 8,
    cost: 1500,
    synergy: ['berserker', 'mage'],
    description: 'Тёмный эльф-убийца. Наносит смертельный урон из тени, не оставляя следов.',
    skill: 'Удар из Тени',
    skillDesc: 'Первый клик после паузы ×20 урона',
    element: 'Тьма',
    color: '#9B30FF',
  },
  {
    ...
    dps: 18,
    cost: 950,
    synergy: ['berserker', 'druid'],
    description: 'Духовный вождь северных племён. Призывает духов предков в бою.',
    skill: 'Дух Волчьей Стаи',
    skillDesc: 'DPS ×3 на 15 секунд раз в минуту',
    element: 'Гром',
    color: '#F59E0B',
  },
  {
    ...
    cost: 2000,
    synergy: ['mage', 'druid'],
    description: 'Повелительница звёздной магии. Черпает силу из самих созвездий.',
    skill: 'Звёздный Ливень',
    skillDesc: 'Глобальный DPS ×6 на 8 секунд',
    element: 'Свет',
    color: '#60A5FA',
  },
  {
    id: 'death_knight',
    name: 'Ворантус',
    title: 'Рыцарь Вечной Ночи',
    class: 'Рыцарь Смерти',
    rarity: 'legendary',
    image: DEATH_KNIGHT_IMG,
    emoji: '💎',
    level: 1,
    maxLevel: 50,
    owned: false,
    ...
    dps: 30,
    cost: 3000,
    synergy: ['necromancer', 'berserker'],
    description: 'Падший паладин, отдавший душу смерти. Непревзойдённый в атаке и защите.',
    skill: 'Клинок Душ',
    skillDesc: 'Клик + DPS ×4 одновременно на 12 секунд',
    element: 'Смерть',
    color: '#38BDF8',
  },
];
